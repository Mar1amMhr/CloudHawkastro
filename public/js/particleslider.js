...
// в”‚ ParticleSlider                   |                     Version 0.9 в”‚ \\
...
// в”‚ Copyright В© 2013 Tamino Martinius (http://zaku.eu)                 в”‚ \\
// в”‚ Copyright В© 2013 Particleslider.com (http://particleslider.com)    в”‚ \\
// в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤ \\
// в”‚ Terms of usage: (http://particleslider.com/legal/license)            в”‚ \\
...
function ParticleSlider(a) {
  ...
  (b.$container = b.$("#" + b.sliderId)),
    ...
    (b.ctx = b.$canv.getContext("2d", { willReadFrequently: true })),
...
(psParticle.prototype.move = function () {
  ...
  if (this.ttl != null && this.ttl-- <= 0) a.swapList(b, a.pxlBuffer, a.recycleBuffer), (this.ttl = null);
    ...
    var c = this.gravityX + a.swipeOffset - this.x,
      ...
      f = Math.atan2(d, c),
      g = e * 0.01;
    a.restless == !0 ? (g += Math.random() * 0.1 - 0.05) : g < 0.01 && ((this.x = this.gravityX + 0.25), (this.y = this.gravityY + 0.25));
    var h = 0,
      i = 0;
    if (a.mx >= 0 && a.mouseForce) {
      ...
      (h = Math.min(a.mouseForce / (Math.pow(j, 2) + Math.pow(k, 2)), a.mouseForce)),
        (i = Math.atan2(k, j)),
        typeof this.color == "function" && ((i += Math.PI), (h *= 0.001 + Math.random() * 0.1 - 0.05));
    } else (h = 0), (i = 0);
    ...
    while (j != null) {
      ...
      for (g = e; g < e + a.ptlSize && g >= 0 && g < a.cw; g++)
        for (h = f; h < f + a.ptlSize && h >= 0 && h < a.ch; h++)
          (d = (h * b.width + g) * 4), (i = typeof j.color == "function" ? j.color() : j.color), (c[d + 0] = i[0]), (c[d + 1] = i[1]), (c[d + 2] = i[2]), (c[d + 3] = i[3]);
      j = j.next;
    }
  ...
  (ParticleSlider.prototype.getPixelFromImageData = function (a, b, c) {
    ...
    for (var f = 0; f < a.width; f += d.ptlGap + 1)
      for (var g = 0; g < a.height; g += d.ptlGap + 1)
        (i = (g * a.width + f) * 4),
          a.data[i + 3] > 0 &&
            e.push({ x: b + f, y: c + g, color: d.monochrome == !0 ? [d.colorArr[0], d.colorArr[1], d.colorArr[2], d.colorArr[3]] : [a.data[i], a.data[i + 1], a.data[i + 2], a.data[i + 3]] });
    return e;
  }),
